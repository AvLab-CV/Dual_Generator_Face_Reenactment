...
@torch.no_grad()
def show_lm(nets, args, x1_label,x2_label,x3_label,x4_label,one_hot_x1,one_hot_x3,x1_id, x3_id,filename):
    # N, C, H, W = x1.size()
    N, C = x1_label.size()
    ...
    for i  in range(32):
        save_image(real_lm2[i], 1, filename+str(i) +'.jpg')
...
def debug_image(nets, args, inputs, step):
    ...
    show_lm(nets, args, param_x1,param_x2,param_x3,param_x4,one_hot_x1,one_hot_x3,x1_id, x3_id,filename)
