...
class Lm_linear_encoder(nn.Module):
    def __init__(self, input_size=136, hidden_size = 136, output_size=64):
        super().__init__()
...
class Id_linear_encoder(nn.Module):
    def __init__(self, input_size=136, hidden_size = 136, output_size=128):
        super().__init__()
        self.input_size = input_size
        self.hidden_size = hidden_size
        self.output_size = output_size
...
class Linear_decoder(nn.Module):
    def __init__(self, input_size=192, hidden_size = 192, output_size=136):
        super().__init__()
        self.input_size = input_size
        self.hidden_size = hidden_size
        self.output_size = output_size
